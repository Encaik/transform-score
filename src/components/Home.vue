<template>
  <div class="flex h-full w-full">
    ...
    <div class="flex flex-col w-6/12">
      <div class="flex">
        <div class="w-40 cursor-pointer border-solid border-2 border-blue-500" @click="onScoreTabClick(ScoreAbc)">abc</div>
        <div class="w-40 cursor-pointer border-solid border-2 border-blue-500" @click="onScoreTabClick(ScoreVexflow)">vexflow</div>
      </div>
      <component :is='renderType' class="flex-1" v-model:score="score"></component>
    </div>
  </div>
</template>
...
import ScoreAbc from './ScoreAbc.vue';
import ScoreVexflow from './ScoreVexflow.vue';
...
let editor;
let renderType = shallowRef(ScoreAbc);

function onScoreTabClick(value){
